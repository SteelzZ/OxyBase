...
{             
    ...
    /**
     * @var Account_Lib_Query_ProductConfiguration
     */
    protected $_productConfigurationDto;
    
    /**
     * @var Account_Lib_Query_ConfigurationInformation
     */
     ...
     * @param Account_Lib_Query_ProductConfiguration $productConfigurationDto
     * @param Account_Lib_Query_ConfigurationInformation $configurationInformationDto
     * @param Account_Lib_Query_ServiceProviderConfiguration $serviceProviderConfigurationDataDto
     */
    public function __construct(
        Oxy_Cqrs_Queue $globalQueue,
        Account_Lib_Service_Read_AccountManagementService $accountManagementReadService,
        Account_Lib_Query_ProductConfiguration $productConfigurationDto,
        Account_Lib_Query_ConfigurationInformation $configurationInformationDto,
        Account_Lib_Query_ServiceProviderConfiguration $serviceProviderConfigurationDataDto
    )
    {
    ...
    public function startProductConfiguration(Oxy_Guid $configurationGuid)
    {
        ...
        if(isset($configurationData['_id'])){
            ...
            $command = Oxy_Cqrs_Command_CommandAbstract::factory(
            'Account_Lib_Command_DoStartNewProductConfiguration', 
                array(
                    $configurationGuid,
    ...
    )
    {
        ...
        if(
            ...
            && $configurationData['configurationState'] !== Account_Domain_Account_ValueObject_State::SERVICE_CONFIGURATION_FINISHED
        ){      
            $configurationProperties = $this->_productConfigurationDto->getDto(
                array(
                    'productName' => $configurationData['productName'],
            ...
            $command = Oxy_Cqrs_Command_CommandAbstract::factory(
            'Account_Lib_Command_DoExecuteConfigurationAction', 
                array(
                    $configurationGuid,
                    (string)$configurationGuid,
    ...
    {       
        ...
        $command = Oxy_Cqrs_Command_CommandAbstract::factory(
            'Account_Lib_Command_DoProcessConfigurationActionResults', 
            array(
                $configurationGuid,
                (string)$configurationGuid,
                $results
    ...
    )
    {
        ...
        $command = Oxy_Cqrs_Command_CommandAbstract::factory(
        'Account_Lib_Command_DoExecuteServiceCommand', 
            array(
                $serviceGuid,
                (string)$serviceGuid,
                $providerName,
