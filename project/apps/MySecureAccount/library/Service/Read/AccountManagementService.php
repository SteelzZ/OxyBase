<?php
class MySecureAccount_Lib_Service_Read_AccountManagementService
{    
    /**
    ...
    /**
     * @param MySecureAccount_Lib_Query_AccountInformation $accountInformationDtoBuilder
     */
    public function __construct(
        MySecureAccount_Lib_Query_AccountInformation $accountInformationDtoBuilder
    )
    {
