<?php
class MySecureAccount_Lib_Query_DevicesWithProductsInformation
    ...
    public function getDto(array $args = array())
    {
        ...
        try{
            ...
            $configurationErrosCollection = $this->_db->selectCollection(
                MySecureAccount_Lib_Query_ConfigurationErrorsInformation::CONFIG_ERRORS_COLLECTION
            );
                    ...
                    if(isset($deviceData['installations'])){
                        ...
                        foreach ($deviceData['installations'] as $installationKey => $installation){
                            ...
                            if(
                                ...
                                || $configurationsHash[$instllations[$installationKey]['productData']['activeConfiguration']]['configurationState'] === MySecureAccount_Domain_Account_ValueObject_State::SERVICE_CONFIGURATION_STARTED
                            ){
                                $status = self::FAILED;
