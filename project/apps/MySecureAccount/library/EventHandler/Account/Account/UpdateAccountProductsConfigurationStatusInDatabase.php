 ...
 */
class MySecureAccount_Lib_EventHandler_Account_Account_UpdateAccountProductsConfigurationStatusInDatabase 
    ...
    implements Oxy_EventStore_EventHandler_EventHandlerInterface
{
     ...
     */
    public function handle(Oxy_Domain_Event_EventInterface $event)
    {   
    } 
}
