...
class Oxy_Controller_Router_Route_Domain extends Zend_Controller_Router_Route_Module
{
	...
	protected function _setRequestKeys()
	{
		...
		{
			// Oxy extending
			$this->domainKey = $this->_request->getDomainKey();
		...
		{
			$this->_defaults += array($this->domainKey => $this->_dispatcher->getDefaultDomain(),
	...
	public function match($path, $partial = false)
	{
		...
		if ($path != '')
		{
			...
			{
				$values[$this->domainKey] = array_shift($path);
			}
	...
	public function assemble($data = array(), $reset = false, $encode = true, $partial = false)
	{
		...
		$url = '';
		if ($this->isDomainValid || array_key_exists($this->domainKey, $data))
		{
			if ($params[$this->domainKey] != $this->_defaults[$this->domainKey])
			{
				$str_domain = $params[$this->domainKey];
			}
		}
		unset($params[$this->domainKey]);
