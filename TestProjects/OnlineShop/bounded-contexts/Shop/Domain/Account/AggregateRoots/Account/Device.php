<?php
namespace Shop\Domain\Account\AggregateRoots\Account;
use Oxy\Domain\AggregateRoot\EventSourcedChildEntityAbstract;

class Device extends EventSourcedChildEntityAbstract
{     
    /**
