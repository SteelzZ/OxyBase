 ...
 **/
class Oxy_Loader_Autoloader
{
    /**
     * @var Oxy_Loader_Autoloader Singleton instance
     */
    ...
    public static function autoload($class)
    {
        ...
        foreach ($self->getClassAutoloaders($class) as $autoloader) {
            if ($autoloader instanceof Zend_Loader_Autoloader_Interface) {
	            ...
	            if ($object instanceof Zend_Loader_Autoloader_Interface) {
	                if ($object->autoload($class)) {
	                    return true;
	                }
	            }else{
     ...
     * @return bool|Oxy_Loader_Autoloader Returns boolean if no argument is passed, object instance otherwise
     */
