<?php
class MySecureAccount_Lib_Service_Write_AccountManagementService
{
    /**
     * @var Oxy_Cqrs_Queue
     */
    ...
    public function remindPassword($emailAddress)
    {
        $accountGuid = new Oxy_Guid();            
        $command = Oxy_Cqrs_Command_CommandAbstract::factory(
            'MySecureAccount_Lib_Command_DoRemindPassword', 
            array(
                $accountGuid,
                $emailAddress
            )
    ...
    public function remindActivationKey($emailAddress)
    {
        $accountGuid = new Oxy_Guid();            
        $command = Oxy_Cqrs_Command_CommandAbstract::factory(
            'MySecureAccount_Lib_Command_DoRemindEmailActivationKey', 
            array(
                $accountGuid,
                $emailAddress
            )
    ...
    public function changePassword($emailAddress, $password)
    {
        ...
        $accountGuid = new Oxy_Guid();            
        $command = Oxy_Cqrs_Command_CommandAbstract::factory(
            'MySecureAccount_Lib_Command_DoChangePassword', 
            array(
                $accountGuid,
                $emailAddress,
                $password
    ...
    { 
        ...
        $command = Oxy_Cqrs_Command_CommandAbstract::factory(
            'MySecureAccount_Lib_Command_DoUpdatePersonalDetails', 
            array(
                $accountGuid,
                $emailAddress,
                $normalized
    ...
    public function changeAccountOwnerDeliveryInformation($emailAddress, array $deliveryInformation)
    {
        ...
        $command = Oxy_Cqrs_Command_CommandAbstract::factory(
            'MySecureAccount_Lib_Command_DoChangeDeliveryAddress', 
            array(
                $accountGuid,
                $emailAddress,
                $normalized
    ...
    public function removeAccount($emailAddress)
    {
        ...
        $command = Oxy_Cqrs_Command_CommandAbstract::factory(
            'MySecureAccount_Lib_Command_DoDeleteAccount', 
            array(
                $accountGuid,
                $emailAddress
            )
