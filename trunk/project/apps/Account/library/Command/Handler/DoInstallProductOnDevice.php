 ...
 */
class Account_Lib_Command_Handler_DoInstallProductOnDevice
    extends Oxy_Cqrs_Command_Handler_EventStoreHandlerAbstract
{
    ...
    public function execute(Oxy_Cqrs_Command_CommandInterface $command)
    {
        ...
        $productName = new Account_Domain_Account_ValueObject_Name($command->getProductName());
        $deviceName = new Account_Domain_Account_ValueObject_Name($command->getDeviceName());
        $productLicense = new Account_Domain_Account_ValueObject_License(
            $command->getProductLicense()
        );
        ...
        $account->installProductOnDevice(
            $productName,
            $productLicense,
            $deviceName,
            $settings
